 ...
 * This has half the volume (area) from the control.
 * In an ideal gas situation, the pressure will double.
 * However, since the molecules take up significant space, there is significant deviation.
 * @author Wei Liang
 */
public class HalfVolume {
	
	public static void main(String[] args) {
		Locale[] lang = {
				Locale.ENGLISH
		};
		Simulator.fieldPrefWidth = 250; 
		Simulator.fieldPrefHeight = 500;
